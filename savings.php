...
<!--                                <h2>Students</h2>-->
                            ...
                            <div class="x_content">
<form action="savings.php" type="submit" method="POST">
...
Enter date(yyyy-mm-dd)<input type="text" name="date">
    ...
    <div style="text-align: center">
        <button type="submit" class="btn btn-success" style="position: absolute;top: 50%;">    Submit
        </button>
                                </div>
                        </div>
                    </div>
...
While($row=mysqli_fetch_assoc($res1)) {
        ...
        echo "$xx";
        $stud = $row["sid"];
$query = "INSERT INTO savings (amt,sid,uid,datee) VALUES ($no,$stud,$k,'$xx')";
        $res = mysqli_query($connection,$query);
